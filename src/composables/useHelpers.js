export function useHelpers() {
    ...
    const getGridClasses = () => {
        ...
        // Mobile uses a tighter gap so each of the 2 columns gets more width
        // for the product image; from sm and up we restore the roomier gap.
        return [
            'grid',
            'grid-cols-2',
            'gap-2 sm:gap-4',
